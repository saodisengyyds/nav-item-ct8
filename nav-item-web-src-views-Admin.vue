  ...
  <div v-else class="admin-layout">
    <aside class="admin-sider" :class="{ open: siderOpen }" @click.self="closeSider">
      ...
      <ul class="menu-list">
        ...
        <li :class="{active: page==='data'}" @click="page='data'; closeSider()">数据管理</li>
      </ul>
    </aside>
    <main class="admin-main">
      ...
      <div class="admin-content">
        ...
        <DataManage v-if="page==='data'" />
      </div>
      <footer class="admin-footer">
        <p class="admin-copyright">Copyright © Nav-Item | <a href="https://860157.xyz/" target="_blank" class="footer-link">Powered by one</a></p>
      </footer>
    </main>
  </div>
</template>
...
import DataManage from './admin/DataManage.vue';
